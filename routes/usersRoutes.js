...
const userUpload = require("../middleware/uploadProfile");

Router.get('/users', middleware.checkToken, controller.getUsers) // GET ALL USERS
...
Router.post('/users/add', userUpload.middlewareUploadProfile, controller.addUser) // POST PROFILE
