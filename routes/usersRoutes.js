...
Router.patch('/edit', middleware.checkToken, controller.editUser) // EDIT PROFILE
Router.delete('/delete', middleware.checkToken, controller.deleteUser) // DELETE PROFILE
